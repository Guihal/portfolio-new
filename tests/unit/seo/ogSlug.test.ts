...
describe("ogSlug", () => {
	...
	it("2 segments → projects-u24", () => expect(ogSlug("/projects/u24")).toBe("projects-u24"));
	...
	it("trailing slash игнорируется", () => expect(ogSlug("/about/")).toBe("about"));
	it("dublicate slashes игнорируются", () => expect(ogSlug("//about//")).toBe("about"));
