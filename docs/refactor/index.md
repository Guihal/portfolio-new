...
**Метрики после фазы:** см. `post-phase-8-loc.txt` vs `baseline-loc.txt`. Top-LOC до/после: About.vue 271→36, Shortcut/Base.vue 141→38, Tooltip.vue 124→83, server/utils/manifest.ts 89→разбит на 3 файла (≤50 каждый).
