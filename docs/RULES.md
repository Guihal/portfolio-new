...
> **Last updated:** generated by P8-01 (`scripts/check-rules-drift.ts` сверяет git-hash этого файла; обновлять header при каждом ручном edit).
> **Status:** proposed (введён в P8-01, enforced level error в P8-18).
